...
const _getRssData = (resource, context, complete, modules) => {
  rss.getRssData(resource, context, modules, (err, result) => {
    if (err) {
...
const getRssData = (context, complete, modules) => _getRssData('RSS', context, complete, modules);
