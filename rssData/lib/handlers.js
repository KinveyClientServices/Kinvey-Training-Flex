...
const _getRssData = (resource, id, complete, modules) => {
  rss.getRssData(resource, id, modules, (err, result) => {
    if (err) {
...
const getRssData = (context, complete, modules) => _getRssData('RSS', context.entityId, complete, modules);
